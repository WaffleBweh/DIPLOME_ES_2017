...
%\begin{figure}[htp]
%    \centering
%    \begin{tikzpicture}[thick, scale=1.25, every node/.style={transform shape}]
%        \umlsimpleclass[x=0, y=0]{Model}
%        \umlsimpleclass[x=0, y=-2]{View}
%        \umlsimpleclass[x=-4, y=-4]{ArrayExtensions}
%        \umlsimpleclass[x=-0, y=-4]{ColorExtensions}
%        \umlsimpleclass[x=4, y=-4]{ComboboxExtensions}
%        
%        \umlassoc[]{Model}{View}
%        \umlassoc[]{ArrayExtensions}{View}
%        \umlassoc[]{ColorExtensions}{View}
%        \umlassoc[]{ComboboxExtensions}{View}
%    \end{tikzpicture}
%\end{figure}
